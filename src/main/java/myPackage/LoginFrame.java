...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(74, 94, 107));
        jPanel2.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.setForeground(new java.awt.Color(255, 255, 255));

        btnLogin.setBackground(new java.awt.Color(50, 74, 89));
        ...
        jLabel1.setText("Equipment Management System");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        else if(username.toString().equalsIgnoreCase("admin") && password.toString().equals("admin"))
        {
            txtUsername.setText("");
            txtPassword.setText("");
        ...
        else if(username.toString().equalsIgnoreCase("Guest"))
        {
            JOptionPane.showMessageDialog(this, "Login As Guest.");
